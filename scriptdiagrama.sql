...
CREATE TABLE IF NOT EXISTS `db_loja_games`.`tb_produtos` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_tb_produtos_tb_categorias_idx` (`tb_categoria_id` ASC) VISIBLE,
  INDEX `fk_tb_produtos_tb_usuarios1_idx` (`tb_usuario_id` ASC) VISIBLE,
